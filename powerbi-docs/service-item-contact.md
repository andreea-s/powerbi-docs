...
* The item level contacts are not shown in Power BI apps, instead the person publishing the app is shown for new workspaces and the Office 365 Group is shown for classic workspaces. In Power BI apps, you can provide a support site link to help app users get help.
